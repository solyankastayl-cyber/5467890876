...
Base URL: https://trade-optimizer-24.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://trade-optimizer-24.preview.emergentagent.com').rstrip('/')
