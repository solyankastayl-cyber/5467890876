...
Base URL: https://order-state-verify.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://order-state-verify.preview.emergentagent.com').rstrip('/')
